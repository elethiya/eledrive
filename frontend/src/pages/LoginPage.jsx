...
import { HardDrive, ArrowRight, Lock, Mail, KeyRound, CheckCircle2, ArrowLeft, Send, AlertTriangle, Wrench } from 'lucide-react';
import { useAuth } from '../context/AuthContext';
import { authAPI } from '../api/client';
import RegistrationReviewScreen from '../components/RegistrationReviewScreen';

export default function LoginPage({ onNavigateRegister, maintenanceInfo }) {
  const { login } = useAuth();
              ...
              <div className="mb-5 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-200 shadow-xl shadow-amber-500/5 space-y-2 animate-in fade-in zoom-in-95 duration-300">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-[11px] text-amber-300/80 mt-0.5">Admin & Owner Access Only</div>
                  </div>
                </div>
                ...
                <div className="text-[10px] text-amber-400/90 flex items-center gap-1.5 pt-0.5">
                  ...
                  <span>Regular user accounts are temporarily restricted from signing in.</span>
                </div>
              </div>
            )}
